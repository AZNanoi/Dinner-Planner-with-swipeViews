...
public class ChooseMenuLayout implements Observer {
    ...
    LinearLayout starterListItems;

    public ChooseMenuLayout(View view, DinnerModel model, Activity activity) {
        ...
        this.back_menu_button = (Button) view.findViewById(R.id.back_menu_button);
        this.starterListItems = (LinearLayout) view.findViewById(R.id.starterListItems);
